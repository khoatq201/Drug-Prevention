            ...
            {counselors.map((counselor) => (
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button
                    onClick={() => navigate(`/manager/counselors/${counselor._id}`)}
                  ...
                  <button
                    onClick={() => navigate(`/manager/counselors/${counselor._id}/edit`)}
...
export default ManagerCounselors;